...
__global__ void kernel_solve(
    ...
    const scalar lambda, const scalar mu, const Material material, const scalar damping, const scalar dt,
    int offset,
