...
struct XPBDScene final : Scene
{
    char* name() override { return "XPBD FEM"; }
    ...
    Mesh* build_beam_mesh(const Vector3& pos, const Vector3I& cells, const Vector3& size, const Element element) {
    ...
    Mesh* build_vtk_mesh(const Vector3& pos, const Vector3I&, const Vector3&, const Color&, const std::string& file) {
    ...
    void build_fem_entity(const Vector3& pos, const Vector3I& cells, const Vector3& size, const Color& color, const Element element, const SimulationArgs& args) {
        ...
        e->add_component(new FEM_Dynamic_Generic(args.density, args.distribution, args.young, args.poisson, args.material, args.sub_iteration));
    ...
    void build_xpbd_fem_entity(const Vector3& pos, const Vector3I& cells, const Vector3& size, const Color& color, const Element element, const SimulationArgs& args) {
        Entity* e = Engine::CreateEnity();
        e->add_behaviour(build_beam_mesh(pos, cells, size, element));
