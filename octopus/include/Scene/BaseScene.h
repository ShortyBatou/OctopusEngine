...
struct BaseScene final : Scene
{
    ...
    {  
        ...
        const Vector3 size(1, 2, 1);
        Vector3I cells(32, 64, 32);
        ...
        cells = Vector3I(16, 32, 16);
        build_obj(Vector3(0,0,0), cells,size, Color(0.25f,0.25f,0.85f,0.f), Tetra10, args, true);
