...
__device__ void eval_hessian_sym(Material material, scalar lambda, scalar mu, const Matrix3x3 &F, Matrix3x3 d2W_dF2[6]);
...
__device__ Matrix3x3 assemble_sub_hessian_sym(const Vector3& dFdx, const scalar& V, Matrix3x3 d2W_dF2[9]);