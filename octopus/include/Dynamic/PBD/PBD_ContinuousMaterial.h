...
struct PBD_ContinuousMaterial : public ContinuousMaterial {
    ...
    virtual scalar get_energy(const Matrix3x3& F) { return 0.; }
    virtual void get_PK1_and_energy(const Matrix3x3& F, Matrix3x3& P, scalar& energy) = 0;
    virtual scalar get_stiffness() const { return young; }
...
struct Hooke_First : public PBD_ContinuousMaterial {
    ...
    virtual void get_PK1_and_energy(const Matrix3x3& F, Matrix3x3& P, scalar& energy) override {
    ...
    virtual scalar get_stiffness() const override { return this->lambda; }
};
...
struct Hooke_Second : public PBD_ContinuousMaterial {
    ...
    virtual scalar get_stiffness() const override { return this->mu * 2.f; }
};
...
struct StVK_Second : public PBD_ContinuousMaterial {
    ...
    virtual scalar get_stiffness() const override { return this->mu; }
};
...
struct Material_Union : public PBD_ContinuousMaterial {
    ...
    virtual scalar get_stiffness() const override { return materials[0]->get_stiffness(); }
